...
const Payroll = () => {
  const [payrollRecords, setPayrollRecords] = useState([
    { id: 1, employeeName: 'Alice Johnson', position: 'Software Engineer', salary: 5000, status: 'Paid' },
    { id: 2, employeeName: 'Bob Smith', position: 'Project Manager', salary: 6000, status: 'Paid' },
    { id: 3, employeeName: 'Charlie Brown', position: 'QA Tester', salary: 4000, status: 'Pending' },
  ]);
